            ...
            <CardContent className="p-8 text-center">
              <div className="max-w-3xl mx-auto">
                ...
                <p className="text-muted-foreground leading-relaxed mb-6">
                  With 8+ years of experience in social work, project management, digital automation, 
                  and community development, I bring a unique combination of technical expertise 
                  and compassionate leadership to every project. Let's discuss how my skills 
                  in KoboToolbox, Google Apps Scripts, and advanced Excel can contribute 
                  to your organization's digital transformation and social impact goals.
                </p>
